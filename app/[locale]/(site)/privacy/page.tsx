...
const copy = {
  en: {
    ...
    unsubscribe:
      "We do not sell or share contact data. Recipients can request removal from our records at any time through the unsubscribe page or by direct email contact.",
  ...
  nl: {
    ...
    unsubscribe:
      "Wij verkopen of delen geen contactgegevens. Ontvangers kunnen op elk moment verzoeken om uit onze bestanden verwijderd te worden via de unsubscribe-pagina of via direct e-mailcontact.",
  ...
  fr: {
    ...
    unsubscribe:
      "Nous ne vendons ni ne partageons aucune donnée de contact. Les destinataires peuvent demander à tout moment la suppression de leurs coordonnées de nos fichiers via la page de désinscription ou par contact direct par e-mail.",
  ...
  return (
    <article className="article-shell">
      ...
      <div className="article-main prose">
        ...
        <p>
          {t.unsubscribe} <Link href="/unsubscribe">{t.unsubscribeLabel}</Link>
        </p>
      </div>
    </article>
  );
