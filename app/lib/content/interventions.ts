...
`,
    ...
    <p>Dat het denken, hoe het ook moge heten, stopt noch verstomt – het is een overtuiging die aan de basis ligt van <em>De Witte Raaf</em>, en van dit nummer in het bijzonder. In een tiental essays en artikelen wordt de uitdaging aangegaan om beter te denken, vanuit de overtuiging dat alleen zo een beter leven binnen bereik komt. De belangrijkste aanname: er is geen denken dat niet door lezen wordt voorbereid; redeneren is reageren, wat kunst en cultuur meteen van een bestaansreden voorziet. Deze teksten zijn op diverse manieren uitgelokt – door maatschappelijke evoluties, door kunstwerken, boeken en tentoonstellingen, maar ook door andermans theorieën.</p>

    <p>Julie Van der Wielen analyseert onder meer het werk van Klaus Theweleit om na te gaan hoe ontsporende mannelijkheid tot fascisme kan leiden. Stéphane Symons herleest sleutelteksten van Walter Benjamin om onze relatie tot herhaling en verschil anders te duiden. Judith Wambacq recenseert een expo in het Palais de Tokyo waarin de invloed van French Theory op Amerikaanse kunst aanschouwelijk wordt. Tessa de Vet, Bas Blaasse en Vlad Ionescu bespreken recente boeken van respectievelijk Emanuele Coccia, Grant Kester en T.J. Clark, wat reflecties oplevert over de macht en onmacht van kunst in de eenentwintigste eeuw. Noortje de Leij confronteert de canonieke interpretatie van het oeuvre van Marcel Broodthaers door Benjamin Buchloh met enkele sleutelgedachten van Adorno, en herdenkt zo het werk van de Belgische kunstenaar. Het nummer besluit met drie miniverzamelingen filosofische fragmenten, opgetekend door Frank Vande Veire, Jan Op de Beeck en Emiel Roothooft.</p>
  ...
  `,
    ...
    <p>That thinking, whatever it may be called, neither stops nor falls silent — this is a conviction that lies at the basis of <em>De Witte Raaf</em>, and of this issue in particular. Across some ten essays and articles, the challenge is taken up to think better, from the conviction that only in this way can a better life come within reach. The fundamental assumption is this: there is no thinking that is not prepared by reading; reasoning is reacting, which at once provides art and culture with a reason for being. These texts have been provoked in various ways — by social developments, by artworks, books, and exhibitions, but also by the theories of others.</p>

    <p>Julie Van der Wielen analyzes, among other things, the work of Klaus Theweleit in order to examine how derailed masculinity can lead to fascism. Stéphane Symons rereads key texts by Walter Benjamin in order to interpret our relation to repetition and difference differently. Judith Wambacq reviews an exhibition at the Palais de Tokyo that makes visible the influence of French Theory on American art. Tessa de Vet, Bas Blaasse, and Vlad Ionescu discuss recent books by Emanuele Coccia, Grant Kester, and T.J. Clark respectively, yielding reflections on the power and powerlessness of art in the twenty-first century. Noortje de Leij confronts Benjamin Buchloh’s canonical interpretation of the work of Marcel Broodthaers with several key ideas from Adorno, and thus rethinks the work of the Belgian artist. The issue concludes with three mini-collections of philosophical fragments noted down by Frank Vande Veire, Jan Op de Beeck, and Emiel Roothooft.</p>
  ...
  `,
    ...
    <p>Que la pensée, quel que soit le nom qu’on lui donne, ne s’arrête ni ne se taise — voilà une conviction qui est au fondement de <em>De Witte Raaf</em>, et de ce numéro en particulier. Dans une dizaine d’essais et d’articles, le défi est relevé de mieux penser, dans la conviction que c’est seulement ainsi qu’une vie meilleure devient accessible. L’hypothèse essentielle est la suivante : il n’y a pas de pensée qui ne soit préparée par la lecture ; raisonner, c’est réagir, ce qui fournit d’emblée à l’art et à la culture leur raison d’être. Ces textes ont été provoqués de diverses manières — par des évolutions sociales, par des œuvres d’art, des livres et des expositions, mais aussi par les théories d’autrui.</p>

    <p>Julie Van der Wielen analyse notamment l’œuvre de Klaus Theweleit afin d’examiner comment une masculinité détraquée peut conduire au fascisme. Stéphane Symons relit des textes clés de Walter Benjamin afin de repenser autrement notre rapport à la répétition et à la différence. Judith Wambacq rend compte d’une exposition au Palais de Tokyo qui rend perceptible l’influence de la French Theory sur l’art américain. Tessa de Vet, Bas Blaasse et Vlad Ionescu discutent des livres récents d’Emanuele Coccia, Grant Kester et T.J. Clark respectivement, ce qui donne lieu à des réflexions sur la puissance et l’impuissance de l’art au XXIe siècle. Noortje de Leij confronte l’interprétation canonique de l’œuvre de Marcel Broodthaers par Benjamin Buchloh à quelques idées-clés d’Adorno et repense ainsi le travail de l’artiste belge. Le numéro se clôt sur trois mini-recueils de fragments philosophiques consignés par Frank Vande Veire, Jan Op de Beeck et Emiel Roothooft.</p>
